    ...
    <div class="container py-4 position-relative z-3 text-white">
        ...
        <section class="py-5 bg-body-tertiary">
            <div class="container py-3">
                <h3 class="fw-bold mb-4 border-start border-warning border-5 ps-3">Lịch Chiếu Hôm Nay</h3>
                
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    <p class="text-body-secondary mb-3">Chọn suất chiếu phù hợp với bạn tại <strong>Nova Cinema Đầm Dơi</strong>:</p>
                    <div class="d-flex flex-wrap gap-3">
                        <a href="booking.php?movie_id=<?= $movie['id'] ?>&time=09:00" class="btn btn-outline-dark fw-bold px-4 py-2 rounded-3">09:00 - 2D Sub</a>
                        <a href="booking.php?movie_id=<?= $movie['id'] ?>&time=13:30" class="btn btn-outline-dark fw-bold px-4 py-2 rounded-3">13:30 - 2D Sub</a>
                        <a href="booking.php?movie_id=<?= $movie['id'] ?>&time=16:15" class="btn btn-outline-dark fw-bold px-4 py-2 rounded-3">16:15 - 2D Lồng Tiếng</a>
                        <a href="booking.php?movie_id=<?= $movie['id'] ?>&time=19:45" class="btn btn-warning text-dark fw-bold px-4 py-2 rounded-3">19:45 - 3D IMAX (Hot)</a>
                        <a href="booking.php?movie_id=<?= $movie['id'] ?>&time=22:00" class="btn btn-outline-dark fw-bold px-4 py-2 rounded-3">22:00 - 2D Sub</a>
                    </div>
                </div>
            </div>
        </section>
